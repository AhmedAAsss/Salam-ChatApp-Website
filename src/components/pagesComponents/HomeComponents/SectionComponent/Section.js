    ...
    <>
      <div id={props.id} className={classes.section_container} style={{ flexDirection: props.flexDirection, backgroundColor: props.b_color }}>
        ...
        <picture style={{ margin: props.margin }}>
          <img style={{ maxHeight: props.img_maxH, padding: props.img_padding }} width="100%" src={props.img_URL1} alt="" />
          <img style={{ maxHeight: props.img_maxH, padding: props.img_padding }} width="100%" src={props.img_URL2} alt="" />
        </picture>
      </div>
    </>
  )
